 ...
 */
const DashboardClientLayout: React.FC<DashboardClientLayoutProps> = ({
  children,
}) => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {/* Main content */}
      <main className="flex-1 p-0 lg:p-6 lg:pt-0 overflow-y-auto transition-all duration-300 lg:ml-64">
