...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: 'Stay updated with the latest CyLink platform improvements and new features.'
  },
  robots: {
    index: true,
    follow: true
      ...
      <header className='border-b border-gray-200 pt-20'>
        <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          ...
          <p className='text-xl text-gray-600 max-w-2xl'>
            Stay up to date with the latest features, improvements, and fixes to CyLink.
          </p>
        </div>
      </header>
